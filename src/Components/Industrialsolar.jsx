    ...
    <div>
      ...
      <section className="services-features py-5" style={{backgroundColor: '#f1f3fb'}}>
        <div className="container">
          <div className="row d-flex justify-content-center">
            <div className="col-md-8 text-center">
              <h6 className="subtitle">Compelling Perks</h6>
              <h2 className="site-heading">What Do You Get From Our Industrial Solar Solutions </h2>
            </div>
          </div>
        ...
        <div className="container">
          <div className="row g-5 d-flex align-items-center">
            <div className="col-md-6">
              ...
              <p>With a proven track record of industrial solar installations, we bring expertise and reliability to every project. Our commitment to custom solutions ensures that your industrial solar system meets your unique needs and goals.</p><br /><hr />
              <ul style={{lineHeight: '2'}}>
                <li><b>Expertise & Experience:</b>&nbsp;Benefit from our years of experience and expertise in industrial solar installations.</li>
                <li><b>Custom Solutions:</b>&nbsp;We understand the unique needs of industrial businesses and provide tailored solutions to maximize efficiency and savings.</li>
                <li><b>Dedicated Support:</b>&nbsp;Count on our dedicated support team to guide you through every step of the process and ensure your solar project's success.</li>
              </ul>
            </div>
            <div className="col-md-6">
