        ...
        <div className="container">
          <div className="row d-flex justify-content-center align-items-center">
            <div className="col-md-9 text-center">
              ...
              <h2 className="site-heading mb-3 " data-aos="fade-up" data-aos-offset="200" data-aos-duration="1200">Commercial Solar Solutions</h2>
          ...
          <div className="row d-flex align-items-center">
            ...
            <div className="col-md-6">
              ...
              <ul style={{lineHeight: '1.5'}}>
                <li data-aos="fade-up" data-aos-offset="200" data-aos-duration="1200">Continuous energy availability</li>
